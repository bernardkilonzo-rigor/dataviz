...
ggcorrplot(corr_matrix, method = "square", type = "full",
...
ggcorrplot(corr_matrix, method = "square", type = "upper",#changing type to "upper"
           lab = TRUE, lab_size = 3.5, lab_col = "gray15",
           colors = c("brown","gray","steelblue"),
           legend.title = "correlation")+
  labs(caption = "Viz by: Bernard Kilonzo", title ="Correlation Matrix Plot")+
...
ggcorrplot(corr_matrix, method = "square", type = "lower",#changing type to "lower"
           lab = TRUE, lab_size = 3.5, lab_col = "gray15",
           colors = c("brown","gray","steelblue"),
           legend.title = "correlation")+
  labs(caption = "Viz by: Bernard Kilonzo", title ="Correlation Matrix Plot")+
...
ggcorrplot(corr_matrix, method = "circle", type = "lower",#method=circle & type=lower
